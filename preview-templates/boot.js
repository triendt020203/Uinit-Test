(function () {
    ...
    window.CyberGlobals = {
        ...
        gameConfig: {
            //globalChatUrl: "ws://dev.gamezoka.com:8444/zone/Lucky9/",
            appId: 474608668887167,
            isPreviewMode: true,
    ...
    function getDataAsync() {
        FBInstant.player
            .getDataAsync(['gameLocale', 'guserid', 'tutorialPlayedV1', 'm', 's', 'avatarId', 'noel_1_99'])
            .then(function (data) {
                console.log(data);
                ...
                if (data['avatarId'])
                    CyberGlobals.avatarId = parseInt(data['avatarId']);
                ...
                if (data['gameLocale'])
                    ...
                    if (locale == "th_TH") {
                        CyberGlobals.gameLocale = locale;
        ...
        var onStart = function () {
            ...
            cc.assetManager.loadAny({
                ...
                if (CyberGlobals.gameConfig.debugLoadingProgress)
                    console.log("Startscene progress: " + percent.toFixed(2) + '%');
